...
describe("board async actions", () => {
  ...
  describe("ADD_BOARD", () => {
    it("should create an addBoard action - personal board", () => {
      ...
      return store
        .dispatch(boardActions.addBoard("userId", null, "boardName"))
        .then(() => {
    ...
    it("should create an addBoard action - organization board - fail", () => {
      ...
      return store
        .dispatch(boardActions.addBoard("userId", "orgId", "boardName"))
        .then(() => {
          expect(store.getActions()).toEqual(expectedActions);
        });
    });
  ...
  describe("UPDATE_BOARD_NAME", () => {
    it("should create an updateBoardName action - organization board", () => {
      ...
      return store
        .dispatch(boardActions.updateBoardName("orgId", "boardId", "boardName"))
        .then(() => {
          expect(store.getActions()).toEqual(expectedActions);
        });
    });
    ...
    xit("should create an updateBoardName action - personal board", () => {
      ...
      return store
        .dispatch(boardActions.updateBoardName("", "boardId", "boardName"))
        .then(() => {
          expect(store.getActions()).toEqual(expectedActions);
        });
    });
