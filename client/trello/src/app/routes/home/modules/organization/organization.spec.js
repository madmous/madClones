...
describe("organization actions", () => {
  ...
  it("should create updateOrganizations action", () => {
    ...
    expect(organizationActions.updateOrganizations(payload)).toEqual(
      expectedAction
    );
  });
  ...
  it("should create addOrganizationRequest action", () => {
    ...
    expect(organizationActions.addOrganizationRequest()).toEqual(
      expectedAction
    );
  });
  ...
  it("should create addOrganizationSuccess action", () => {
    ...
    expect(organizationActions.addOrganizationSuccess()).toEqual(
      expectedAction
    );
  });
  ...
  it("should create addOrganizationFail action", () => {
    ...
    expect(organizationActions.addOrganizationFail(payload)).toEqual(
      expectedAction
    );
  });
  ...
  it("should create an action to addOrganization - success", () => {
    ...
    return store.dispatch(organizationActions.addOrganization()).then(() => {
